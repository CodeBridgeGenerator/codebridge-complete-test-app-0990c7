...
const Objext121CreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        ...
        await client.service("objext121").patch(_entity._id, _data);
        ...
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info objext121 updated successfully" });
    ...
    return (
        <Dialog header="Edit Objext 121" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="objext121-edit-dialog-component">
