...
fieldObecjt1: _entity?.fieldObecjt1,
        ...
        const result = await client.service("arrayfields").create(_data);
        props.onHide();
        props.alert({ type: "success", title: "Create info", message: "Info arrayfields created successfully" });
    ...
    return (
        <Dialog header="Create Arrayfields" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="arrayfields-create-dialog-component">
