...
fieldDateTime247: _entity?.fieldDateTime247,
        ...
        const result = await client.service("allfields").create(_data);
        props.onHide();
        props.alert({ type: "success", title: "Create info", message: "Info allfields created successfully" });
    ...
    return (
        <Dialog header="Create Allfields" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="allfields-create-dialog-component">
